...
public class DomainOptimizerModel implements Model {
  ImmutableList<ValueAssignment> assignments;

  public void setAssignments(ImmutableList<ValueAssignment> pAssignments) {
  ...
  @Override
  public @Nullable BigInteger evaluate(IntegerFormula f) {
    return null;
  }
