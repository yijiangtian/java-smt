 ...
 *
 * <p>In general, interpolants are requested over formulas identified by their corresponding
 * {@link InterpolationHandle}s, generated by adding the constraints to the stack.
 * When generating the interpolant using any of the methods, the formulas which were asserted,
 * but for which the corresponding {@link InterpolationHandle} is not present in the query are
 * treated as background theory and their symbols might be present in the resulting interpolants.
 *
...
public interface InterpolatingProverEnvironment extends BasicProverEnvironment {
   ...
   * {@code assumptions} is satisfiable.
   *
